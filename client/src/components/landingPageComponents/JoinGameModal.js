  ...
  return (
    <div onSubmit={handleSubmit}>
      ...
      <div className="absolute w-96 h-80 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[#3D405B] bg-[#F2CC8F] drop-shadow-2xl z-20  rounded-lg">
        ...
        <form
          className="h-80 w-max flex flex-col items-center justify-center m-auto p-1"
          onSubmit={handleSubmit}
        >
          <h2 className="max-w-max p-2 mb-4 text-3xl">Enter Game Code:</h2>
          <input
            className="mb-4 rounded-sm text-[#3D405B] text-3xl text-center"
            type="text"
            ref={codeRef}
          />
...
const buttonStyle =
  "p-2 bg-[#81B29A] rounded w-60 h-16 text-xl text-[#3D405B] font-bold hover:outline hover:outline-4 hover:outline-[#E07A5F]";
